    ...
    public class Unattend
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if (activity == null) throw new RestException(HttpStatusCode.NotFound, new {Activity = "Cound not find activity"});
                ...
                if (attendance.IsHost) throw new RestException(HttpStatusCode.BadRequest, new {Activity = "You cannot remove yourself as host"});
